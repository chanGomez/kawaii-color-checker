...
function CardFive() {
  return (
    ...
    <div className="card-five__title">Web Design templates
        Selection</div>
    <div className="card-five__subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elitsed do eiusmod.</div>
